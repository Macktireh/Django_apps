...
class Profile(models.Model):
    ...
    link_linkedin = models.CharField(_("linkedin profile link"), max_length=5000, blank=True)
    link_gitthub = models.CharField(_("gitthub profile link"), max_length=5000, blank=True)
    link_twitter = models.CharField(_("twitter profile link"), max_length=5000, blank=True)
    link_mysite = models.CharField(_("mysite link"), max_length=5000, blank=True)
